...
class FormScreen7 extends StatefulWidget {
  String get title => null;
  @override
  State<StatefulWidget> createState() {
    return FormScreen7State();
  }
}

class FormScreen7State extends State<FormScreen7> {
  ...
  Widget build(BuildContext context) {
    Future<void> envoyerMessage(String matriculeEt,String typeMessage, String objetMess , String Message) async {
      var url = 'http://192.168.8.105/projet_mobile_multimedia/public/api/message';
      int elemt = 2;
